...
{
  return ((this->center - sphere.center).length() <= this->radius + sphere.radius); // total internal reflection
}
...
{
  return (this->center - p).length() < this->radius; // total internal reflection
}